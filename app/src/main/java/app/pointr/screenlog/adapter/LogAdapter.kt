package app.pointr.screenlog.adapter
...
import app.pointr.screenlog.model.Logs
...
class LogAdapter internal constructor(private val subject: BehaviorSubject<List<app.pointr.screenlog.model.Logs>>
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var messageList: List<Logs> = listOf()
    ...
    override fun onAttachedToRecyclerView(recyclerView: RecyclerView) {
        ...
        if (disposable == null) {
            disposable = subject.sample(SAMPLE_DURATION_MS, TimeUnit.MILLISECONDS, true)
                    ...
                    .subscribe { newList: List<app.pointr.screenlog.model.Logs> ->
    ...
    private class MessageDiffUtilCallback(
            private val oldList: List<Logs>,
            private val newList: List<Logs>
    ) : DiffUtil.Callback() {
